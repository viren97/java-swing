 ...
 * @author viren
 */
public class priorityPrem extends javax.swing.JFrame {

    /**
     * Creates new form priorityPrem
     */
    public priorityPrem(int a) {
        initComponents();
             int size = a;
       loadtable(size);
    }

    private priorityPrem() {
  ...
  public void loadtable(int size)
{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PRIORITY PRE-EMPTIVE");
  ...
  int tot=0,st=0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(priorityPrem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new priorityPrem().setVisible(true);
            }
        });
    }
